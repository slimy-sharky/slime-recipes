# Crosslinking agents
Crosslinking agents are the essential components that transform a liquid polymer base into the cohesive, elastic material we know as slime. By facilitating chemical bonds between individual polymer chains, these agents create a three-dimensional network that provides structural integrity and unique tactile properties. The degree of crosslinking directly determines the final texture—ranging from soft and gooey to firm and rubbery—making them the most critical factor in controlling the slime's consistency.
