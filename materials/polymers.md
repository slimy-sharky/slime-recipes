# Polymers
Polymers are the fundamental building blocks of slime, consisting of long, chain-like molecules made up of repeating structural units. In the context of slime-making, Polyvinyl Alcohol (PVA) is the most essential polymer, acting as the main backbone of the mixture. These long PVA chains are naturally flexible and can slide past each other, which gives the initial glue its liquid state. When these chains interact with other additives, they form the foundation of the slime's texture, providing the necessary elasticity and film-forming capabilities that allow the material to stretch and hold its shape.
